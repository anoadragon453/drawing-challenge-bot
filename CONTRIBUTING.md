# Contributing to drawing-challenge-bot
...
It is **recommended** to use Docker Compose to run drawing-challenge-bot while
...
list](https://github.com/anoadragon453/drawing-challenge-bot/issues). What
